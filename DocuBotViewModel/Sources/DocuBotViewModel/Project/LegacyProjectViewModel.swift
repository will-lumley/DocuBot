...
public class LegacyProjectViewModel: DocuBotViewModel, @unchecked Sendable {
...
public extension LegacyProjectViewModel {
...
private extension LegacyProjectViewModel {
...
extension LegacyProjectViewModel: ChatCellViewModelDelegate {
...
public extension LegacyProjectViewModel {
    ...
    static var mock: LegacyProjectViewModel {
        .init(
            project: .init(
                id: 1,
